...
write_seqs(sapply(guides$guide_seq[which(guides$element_type != "negative_control")], toString), sapply(guides$name[which(guides$element_type != "negative_control")], toString), "WeissmanTilingScreenGuideSequence.fa")
```